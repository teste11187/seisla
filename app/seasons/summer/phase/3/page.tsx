...
export default function SummerPhase3() {
  return (
      ...
      <div className="max-w-4xl mx-auto">
        <div className="flex items-center justify-between mb-8">
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h1 className="text-2xl font-bold text-white">Fase 3: Formulários</h1>
              <p className="text-white/80">Crie formulários interativos</p>
            </div>
          </div>
        </div>
        ...
        <Card className="bg-white/95">
          ...
          <CardContent className="p-8 text-center">
            ...
            <p className="text-gray-600 mb-6">
              Complete as <strong>Fases 1 e 2</strong> para desbloquear!
            </p>
